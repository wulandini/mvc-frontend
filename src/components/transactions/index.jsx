...
import { deposit, withdrawal, transfer, saldo } from '../../action/transactionActions'
...
const Transactions = ({ history }) => {
  ...
  const [descWithdrawal, setAmountWithdrawal] = useState("");
  const [accountTransferSender, setAccountTransferSender] = useState("");
    ...
    <Container>
      <Tabs>
        ...
        <TabPanel>
          ...
          <Form onSubmit={submitWithdrawlHandler} className="mt-3"></Form>
          <Form className="mt-3">
            ...
            >
              ...
              <Col sm="10">
                <Form.Control 
                  ...
                  rows={3} 
                  value={DescWithdrawl}
                  onChange={(e) => setDesWithdrawl(e.target.value)}
                />
              </Col>
            </Form.Group>
            <Col sm={{ span: 10, offset: 11 }}>
